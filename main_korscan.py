...
def main():
    ...
    os.environ["QTWEBENGINE_CHROMIUM_FLAGS"] = "--enable-gpu-rasterization --enable-accelerated-2d-canvas --enable-smooth-scrolling --disable-gpu-vsync=0 --ignore-gpu-blocklist"
